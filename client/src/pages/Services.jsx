    ...
    <SharedPage>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-vulnmap-card border border-vulnmap-border p-10 hover:border-brand-green transition group">
          ...
          <p className="text-gray-550 dark:text-gray-400">Automated integration with your CI/CD pipelines to catch vulnerable packages before they ever reach production. Blocks PRs containing high-risk dependencies.</p>
        </div>
        <div className="bg-vulnmap-card border border-vulnmap-border p-10 hover:border-brand-green transition group">
          <Zap className="w-12 h-12 text-brand-green mb-6" />
          <h3 className="text-2xl font-bold font-mono mb-4">Attack Path Simulation</h3>
          <p className="text-gray-550 dark:text-gray-400">Our AI orchestration layer predicts exactly how an adversary will exploit your stack, generating plain-english remediation steps for your engineers.</p>
        </div>
        <div className="bg-vulnmap-card border border-vulnmap-border p-10 hover:border-brand-green transition group">
          <Search className="w-12 h-12 text-brand-green mb-6" />
          <h3 className="text-2xl font-bold font-mono mb-4">Deep SBOM Analysis</h3>
          <p className="text-gray-550 dark:text-gray-400">Upload standard CycloneDX or SPDX Software Bill of Materials. We map your transitive dependencies up to 10 levels deep to uncover hidden threats.</p>
        </div>
        <div className="bg-vulnmap-card border border-vulnmap-border p-10 hover:border-brand-green transition group">
          <Activity className="w-12 h-12 text-brand-green mb-6" />
          <h3 className="text-2xl font-bold font-mono mb-4">Zero-Day Monitoring</h3>
          <p className="text-gray-550 dark:text-gray-400">24/7 monitoring of the NVD and OSV databases. If a new zero-day affects your mapped stack, we push critical Slack and SMS alerts immediately.</p>
        </div>
      </div>
    </SharedPage>
  );
